...
class event_OPR:
    ...
    def create_team_matrix_map(self):
        ...
        for match in self.matches:
            # Loop through all the teams in a match on both the red and blue alliances
    ...
    def create_score_matrix(self):
        ...
        match_position = 0
        for match in self.matches:
            scores_matrix[match_position] = match['score_breakdown']['blue'][self.metric]
            match_position += 1
            scores_matrix[match_position] = match['score_breakdown']['red'][self.metric]
            match_position += 1
    ...
    def calculate_contribution(self):
        ...
        for team in self.team_matrix_map:
            calculated_contributions[team] = solutions[counter][0]
            counter += 1
